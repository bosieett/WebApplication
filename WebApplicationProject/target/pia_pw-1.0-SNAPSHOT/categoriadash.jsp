...
<body class="bodycover">
    ...
    <div>
        <table id="tablapublicaciones">
            ...
            <tbody>
                <%
                    for(PostDAO elemento:publicaciones.GetPostsByCat((int)request.getSession(false).getAttribute("catid"))){
                %>
                <tr>
            <td>
    ...
    <script>
        $(document).ready(function() {
            $('#tablapublicaciones').DataTable({
                ...
                "language": {
                    "emptyTable":"Aún no hay publicaciones en esta categoría, ¡sé el primero!",
                    "paginate": {
                        "previous": "Anterior",
                        "next": "Siguiente",
                        "first": "Inicio",
